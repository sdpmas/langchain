...
class MosaicML:
    ...
    def call_multiple_prompts(self, prompts: List[str]) -> List[str]:
        """Call out to a MosaicML LLM inference endpoint with multiple prompts.

        Args:
            prompts: The list of prompts to pass into the model.

        Returns:
            The list of strings generated by the model.
        """
        return [self._call(prompt) for prompt in prompts]
